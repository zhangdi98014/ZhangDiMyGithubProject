...
function submitOrder(){
	...
	window.location.href="${pageContext.request.contextPath}/commonapi/index/tg/order_pay/goPayOrderPage?amount=${totalAmount}";
	}
	function delOrder(e){
		var id = $(e).attr("data-id");
		$.ajax({
			type : 'get',
			url : "${pageContext.request.contextPath}/commonapi/index/tg/order_pay/delOrder",
			data : {
				"id":id
				},
