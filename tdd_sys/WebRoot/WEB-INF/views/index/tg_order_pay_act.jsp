...
$(function(){
	...
	function paySuccess(){
		$.ajax({
			type : 'get',
			url : "${pageContext.request.contextPath}/commonapi/index/tg/order_pay/submitOrder",
			data : {
				
			},
			success : function(result) {
				if(result.code==1){
					window.location.href="${pageContext.request.contextPath}/commonapi/index/tg/order_pay/paySuccess";
					}else{
						alert(result.msg);
						}
				}
