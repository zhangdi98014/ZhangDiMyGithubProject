...
<th width="30%">${detail.userInfo.contactName}</th>
</tr>
<tr>
<th width="30%">收货人电话</th>
<th width="30%">${detail.userInfo.contactCelPhone}</th>
</tr>
<tr>
<th width="30%">所在城市</th>
<th width="30%">${detail.userInfo.contactCity}</th>
</tr>
<tr>
<th width="30%">详细地址</th>
<th width="30%">${detail.userInfo.detailAddress}</th>
</tr>
</tbody>
</table>
</div>
<div style="margin-left:30px;">
<a href="${pageContext.request.contextPath}/user/user_info/update?id=${detail.userInfo.id}" class="btn btn-primary  radius">修改收货地址</a>
 </div>
