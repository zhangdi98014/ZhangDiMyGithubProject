...
<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="${pageContext.request.contextPath}/commonapi/index">返回首页</a>
...
<ul class="dropDown-menu menu radius box-shadow">
	<li><a href="${pageContext.request.contextPath}/commonapi/user_logout">退出</a></li>
...
<li>
 ...
 <a  href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/user_info/detail" data-title="我的收货地址" title="我的收货地址"> 
我的收货地址 </a>
</li> 
</ul>
</dd></dl>
...
<ul>
<li> 
<a  href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/pro_order_info" data-title="普通商品订单" title="普通商品订单"> 
普通商品订单 
</a> 
</li> 
 <li>
<a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/user/tg_order_info" data-title="团购订单" title="团购订单"> 
团购订单 </a>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
					<li class="active">
					<span title="我的收货地址" data-href="${pageContext.request.contextPath}/user/user_info/detail">我的收货地址</span>
					<em></em>
					</li>
			</ul>
	</div>
