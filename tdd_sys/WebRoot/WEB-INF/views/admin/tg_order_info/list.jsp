...
<div style="display:inline;margin-top:30px"><span style="width:200px;margin-left:50px;">团长</span>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2569"></script>
...
$(function(){
	...
	function ajaxList(page) {
		...
		$.ajax({
			type : 'get',
			url : "${pageContext.request.contextPath}/admin/tg_order_info/queryList",
			data : {
				"page":page,
				"orderNo":orderNo,
				"tgTitle":tgTitle,
