...
<div class="imgUpload" tip="请上传商品大图，数量不超过1"  red-tip=""  upload-num="1" init-val="" upload-type="1" id="proImg"></div>
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入商品标题" id="title">
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入商品价格（请输入数字）" id="proPrice">
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入商品库存（请输入数字）" id="sctockNum">
</div>
</div>
...
<div id="proDetailDiv2"  class="text" style="min-height:300px;z-index:1">
</div>
</div>
</div>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1392"></script>
...
$(function(){
	...
	function submitData(){
		...
		$.ajax({
			type: 'post',
			url: '${pageContext.request.contextPath}/admin/pro_info/add_submit',
			data:{
				"proImg":proImg,
				"title":title,
				"proTypeId":proTypeId,
