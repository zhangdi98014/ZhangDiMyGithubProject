...
<div class="row cl" id="trainMsgParentContent" style="margin-top:20px;margin-left:20px;" >
<label class="form-label col-xs-4 col-sm-2">
物流信息
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline" value="${data.trainMsg}" placeholder="请输入物流信息" id="trainMsg">
</div>
</div>
</div>
<hr>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5821"></script>
<script type="text/javascript">
$(function(){
})
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/pro_order_info/fh_submit',
		data:{
			"id":'${data.id}',
			"trainMsg":trainMsg
			},
