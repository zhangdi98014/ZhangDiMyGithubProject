...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8830"></script>
<script type="text/javascript">
$(function(){
})
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/tz_info/add_submit',
		data:{
			"name":name,
			"passWord":passWord
			},
