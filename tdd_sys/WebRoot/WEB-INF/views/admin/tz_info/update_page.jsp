...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9902"></script>
<script type="text/javascript">
$(function(){
})
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/tz_info/update_submit',
		data:{
			"id":'${data.id}',
			"name":name,
			"passWord":passWord
