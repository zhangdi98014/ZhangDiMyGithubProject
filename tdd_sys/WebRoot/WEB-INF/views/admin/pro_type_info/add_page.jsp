...
<input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入类型名" id="name">
</div>
</div>
</div>
<hr>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6882"></script>
<script type="text/javascript">
$(function(){
})
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/pro_type_info/add_submit',
		data:{
			"name":name
			},
