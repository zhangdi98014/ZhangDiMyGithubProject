...
<div class="formControls col-xs-8 col-sm-9">
<div class="imgUpload" tip="请上传团购宣传图，数量不超过1"  red-tip=""  upload-num="1" init-val="" upload-type="1" id="tgImg"></div>
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入团购标题" id="tgTitle">
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入团购价格（请输入数字）" id="tgPrice">
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入团购数量（请输入数字）" id="tgNum">
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text Wdate"  readonly="readonly"  style="width:500px;display:inline"   onFocus="WdatePicker({startDate: '%y-%M-%d 00:00:00' ,dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate: true })"  placeholder="请输入团购开始时间" id="tgStartTime">
</div>
</div>
...
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text Wdate"  readonly="readonly"  style="width:500px;display:inline"   onFocus="WdatePicker({startDate: '%y-%M-%d 00:00:00' ,dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate: true })"  placeholder="请输入团购结束时间" id="tgEndTime">
</div>
</div>
</div>
<hr>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9556"></script>
...
$(function(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/tz/tg_info/add_submit',
		data:{
			"proId":proId,
			"tgImg":tgImg,
			"tgTitle":tgTitle,
