...
<div class="row cl" id="trainMsgParentContent" style="margin-top:20px;margin-left:20px;" ><label class="form-label col-xs-4 col-sm-2">
发货物流
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text"  style="width:500px;display:inline" value="${data.trainMsg}" placeholder="请输入发货物流" id="trainMsg">
</div>
</div>
</div>
<hr>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7845"></script>
<script type="text/javascript">
$(function(){
	
})
function submitData(){
	var trainMsg= $('#trainMsg').val();
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/tz/tg_order_info/fh_submit',
		data:{
			"id":'${data.id}',
			"trainMsg":trainMsg
			},
