...
<legend class="text-white">淘多多-注册</legend>
</fieldset>
...
<a  style="color:white;float:left;left:10px;" href="${pageContext.request.contextPath}/commonapi/user_login" onclick="" >前往登录</a>
</div>
