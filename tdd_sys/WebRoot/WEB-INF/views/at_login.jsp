...
<legend class="text-white">淘多多-后台登录</legend>
</fieldset>
...
<input name="loginType" type="radio" value="2" id="loginType2" style="margin-left:10px;"/><label style="color:white" for="loginType2">团长 </label>
</div>
...
$(document).ready(function(e) {
	...
	//获取当前时间，主要是为了刷新验证码，否则会使用缓存的内容，而不会进行更新验证码
			...
			data: {
				...
				success: function(result) {
					if(result.code==1){
						...
						if(lt=='2'){//团长
							window.location.href="${pageContext.request.contextPath}/tz/index";
							}
						}else{
							alert(result.msg);
							}
